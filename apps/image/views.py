...
class UploadImage(CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            path_hubconfig = "C:/Users/bella/Documents/django_yolo_api-master(1)/django_yolo_api-master/yolov5_code"
            path_weightfile = "C:/Users/bella/Documents/django_yolo_api-master(1)/django_yolo_api-master/yolov5_code/best(9).pt"  # or any custom trained model
